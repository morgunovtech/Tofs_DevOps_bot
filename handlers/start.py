...
HELP = (
    ...
    "/help — эта справка\n\n"
    "Где что в меню:\n"
    "🌍 Сайт детально — добавить/убрать сайт, настройки на сайт, пауза\n"
    "⚠️ Инциденты — открытые проблемы, закрыть, «видел, не напоминай»\n"
    "🔍 SEO/GEO — аудит видимости для поисковиков и AI-агентов\n"
    "📋 Ещё — SSL, домены, ссылки, uptime, настройки, тех. окна, "
    "heartbeats, обратная связь\n"
    "🩺 Диагностика — чеклист: что работает, что требует внимания, что можно "
    "подключить; Google, Яндекс и Cloudflare подключаются прямо из чата\n\n"
