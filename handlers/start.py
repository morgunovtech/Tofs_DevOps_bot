...
HELP = (
    ...
    "/help — эта справка\n\n"
    "Главный экран сам показывает, всё ли в порядке с каждым сайтом.\n"
    "🌍 Сайты — карточка сайта со всем сразу: открывается ли, сертификат, домен, ссылки, "
    "поиск и ИИ, простой; там же «я чиню» и настройки сайта\n"
    "🔴 Проблемы — появляется, только когда что-то сломано\n"
    "🔎 Проверить всё сейчас — живая проверка всех сайтов\n"
    "⚙️ Настройки — сводки и тихие часы, плановые работы, статус-страница, диагностика и "
    "подключения (Google, Яндекс, Cloudflare), контроль задач, обратная связь\n\n"
